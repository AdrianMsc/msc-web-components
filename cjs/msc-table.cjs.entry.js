    ...
    },
    {
        ...
        components: [
            ...
            },
            {
                ...
                comment: 'This is the modal table component with frozen column',
                id: 3,
            },
        ],
    },
...
const MscTable = class {
    ...
    render() {
        return (index.h("div", { key: '58b380e8070fe68e8b4ccfa7ba192855b67e8c82', class: "container" }, index.h("h1", { key: 'd7471e42730acccedeabf311903df79d251db718' }, "Component Status"), this.comps.map(category => (index.h("div", { key: category.category }, index.h("h2", { class: "font-bold text-2xl mt-5" }, category.category), index.h("div", { class: "relative overflow-x-auto mt-3" }, index.h("table", { class: "w-full text-sm text-left rtl:text-right text-gray-500" }, index.h("thead", { class: "text-xs text-gray-700 bg-gray-50" }, index.h("tr", null, index.h("th", { scope: "col", class: "px-6 py-3 w-[20%]" }, "\u00A0"), index.h("th", { scope: "col", class: "px-6 py-3 w-[15%]" }, "Figma"), index.h("th", { scope: "col", class: "px-6 py-3 w-[15%]" }, "Guidelines"), index.h("th", { scope: "col", class: "px-6 py-3 w-[15%]" }, "CDN"), index.h("th", { scope: "col", class: "px-6 py-3 w-[15%]" }, "Storybook"), index.h("th", { scope: "col", class: "px-6 py-3", colSpan: 3 }, "Comments"))), index.h("tbody", null, category.components.map(component => {
            var _a, _b, _c, _d;
            return (index.h("tr", { class: "bg-white border-b", key: component.id }, index.h("th", { scope: "row", class: "px-6 py-4 font-medium text-gray-900 whitespace-nowrap" }, component.name), index.h("td", { class: "px-6 py-4" }, (_a = component.statuses.find(status => status.platform === 'Figma')) === null || _a === void 0 ? void 0 : _a.status), index.h("td", { class: "px-6 py-4" }, (_b = component.statuses.find(status => status.platform === 'Guidelines')) === null || _b === void 0 ? void 0 : _b.status), index.h("td", { class: "px-6 py-4" }, (_c = component.statuses.find(status => status.platform === 'CDN')) === null || _c === void 0 ? void 0 : _c.status), index.h("td", { class: "px-6 py-4" }, (_d = component.statuses.find(status => status.platform === 'Storybook')) === null || _d === void 0 ? void 0 : _d.status), index.h("td", { class: "px-6 py-4", colSpan: 3 }, component.comment)));
        })))))))));
    }
};
MscTable.style = MscTableStyle0;

exports.msc_table = MscTable;

//# sourceMappingURL=msc-table.cjs.entry.js.map