...
patchBrowser().then(async (options) => {
  ...
  return index.bootstrapLazy([["msc-drawer.cjs",[[1,"msc-drawer",{"navTitle":[1,"nav-title"],"items":[8],"logo":[1],"isSideNavOpen":[32]}]]],["msc-hello.cjs",[[1,"msc-hello"]]],["msc-table.cjs",[[1,"msc-table",{"comps":[16]}]]]], options);
});
