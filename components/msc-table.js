import { p as proxyCustomElement, H, h } from './p-84084e74.js';
...
const MscTable$1 = /*@__PURE__*/ proxyCustomElement(class MscTable extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return MscTableStyle0; }
}, [1, "msc-table", {
        "comps": [16]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["msc-table"];
    components.forEach(tagName => { switch (tagName) {
        case "msc-table":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MscTable$1);
            }
            break;
    } });
}
...
const MscTable = MscTable$1;
const defineCustomElement = defineCustomElement$1;

export { MscTable, defineCustomElement };
